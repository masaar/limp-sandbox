...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.init = function () {
        ...
        this.api.authed$.subscribe(function (session) {
            if (session) {
                _this.showAuth = _this.guardOn = false;
                _this.authVars.auth = session;
                _this.callArgs.sid = session._id;
                _this.callArgs.token = session.token;
            }
            else {
                _this.showAuth = _this.guardOn = true;
                _this.callArgs.sid = 'f00000000000000000000012';
                _this.callArgs.token = src_environments_environment__WEBPACK_IMPORTED_MODULE_7__["environment"].anon_token;
            }
        });
    };
